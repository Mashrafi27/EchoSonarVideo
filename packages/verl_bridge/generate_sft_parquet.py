...
corresponding column, so the canonical message list from `data_core.sft.serialize` (which
...
from data_core.sft.serialize import serialize_sft   # noqa: E402
from verl_bridge.sample import (build_manifest, parse_caps,  # noqa: E402
                              select, write_ids)
