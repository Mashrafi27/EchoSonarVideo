...
Usage (2 GPUs):
    accelerate launch --num_processes 2 --mixed_precision bf16 \\
        -m echoprime_track.train_sft --epochs 3 --lr 2e-5 --micro-batch 1 --grad-accum 32
...
from echoprime_track.dataset import EchoPrimeCollator, EchoPrimeSFTDataset
from echoprime_track.modeling import EchoPrimeQwen3Config, EchoPrimeQwen3ForCausalLM, VIEW_TOKEN
...
def main(argv=None) -> int:
    ...
    ap.add_argument("--train-jsonl", default="data/raw_vqa/train_vqa_with_thinking.jsonl")
    ...
    print(f"[echoprime_track] SFT complete -> {args.out_dir}", flush=True)
    return 0
