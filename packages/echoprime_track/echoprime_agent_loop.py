...
class EchoPrimeAgentLoop(AgentLoopBase):
    ...
    async def run(self, sampling_params: dict[str, Any], **kwargs) -> AgentLoopOutput:
        ...
        assert actual_views == n_views, (
            ...
            f"agree on view count (see echoprime_track/generate_grpo_parquet.py)")
        ...
        # itself in the text -- data_core.reward.score's _ANSWER_RE needs the closing tag present to
