...
`echoprime_track/rl_dataset.py`'s docstring). Rollout is the one place that channel doesn't reach on its
...
class HFRolloutVideo(HFRollout):
    ...
    def _generate_minibatch(self, prompts: DataProto) -> DataProto:
        ...
        # `prepare_inputs_for_generation` (echoprime_track/modeling.py) only consumes these on the first
