...
# repo root is two levels below the shared data parent, mirroring data_core.config
...
class EnvConfig:
    ...
    # select_view's video path (verl_bridge/echo_tool.py): a CONTINUOUS window, not
