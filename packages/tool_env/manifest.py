...
from data_core.data.studies import index_study, study_dir
from data_core.data.views import canonical_view, base_view


@dataclass
class ViewEntry:
    view_name: str
    clip: object  # data_core.data.studies.Clip
