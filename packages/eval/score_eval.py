"""Score an episodes file into a metrics report.
    ...
    python -m eval.score_eval build/eval_step100.jsonl

Separate from generation on purpose: recomputing a metric must never require
re-running the model. Metrics come from `eval` (CardioBench/EchoSonar-R
definitions), NOT from data_core.reward -- the reward is what we optimise, these
are what we report.
"""
import argparse
import json
...
from data_core.data.answers import finding_set, parse_yes_no          # noqa: E402
from eval.metrics import (balanced_accuracy, bootstrap_ci,  # noqa: E402
                                  macro_f1, majority_baseline, per_class_f1,
                                  set_f1, tool_call_rate, tools_per_episode,
                                  accuracy)
from eval.nlg import nlg_report                             # noqa: E402
from data_core.reward.sections import section_coverage                # noqa: E402
from eval.agentic_loop import strip_think                 # noqa: E402
