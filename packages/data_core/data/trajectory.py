from data_core.data.trace import parse_thinking, findings_text
from data_core.data.views import canonical_view
from data_core.data.frames import evenly_spaced, midframe
