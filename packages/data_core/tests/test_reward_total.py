from data_core.reward.score import extract_answer, score_format, total_reward
...
def test_extract_answer_empty_is_none():
    from data_core.reward.score import extract_answer, score_format
...
def test_serialized_toolcall_scores_as_valid_format():
    from data_core.sft.serialize import serialize_sft
    from data_core.reward.score import score_format
    traj = {
